...
public class RNMeetView extends BaseReactView<JitsiMeetViewListener>
    ...
    public RNMeetView(@NonNull Context context) {
        super(context);
     ...
     *                when doing so.
     */
    public void join(@Nullable RNMeetConferenceOptions options) {
